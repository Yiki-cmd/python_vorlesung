...
# - * matches 0 or more repetitions [0 or many]  aszadfda
# - + matches 1 or more repetitions [1 or many] azasfasdfa
# - ? matches 0 or 1 repetition {axaxa}
# - {} specifies the number of repetitions a{4} aasdfasdfa
...
pattern = r"\\s"       # Match any whitespace (spaces, tabs, newlines), sentence
...
the followed by comma and then followed by 
space and then followed by
exactly word 'age' and the followed space and
then followed one or more digits
